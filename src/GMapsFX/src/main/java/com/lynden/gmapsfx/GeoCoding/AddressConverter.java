package com.lynden.gmapsfx.GeoCoding;
...
public class AddressConverter {
  ...
  */
   ...
   * parameter) ¡ª Indicates whether or not the geocoding request comes
   ...
   */
    ...
    public static void main(String[] args) throws IOException {
        ...
        GoogleResponse res = new AddressConverter().convertToLatLong("calpoly pomona");
        if(res.getStatus().equals("OK"))
        {
            for(Result result : res.getResults())
            {
                System.out.println("Lattitude  :"  +result.getGeometry().getLocation().getLat()+" "+result.getGeometry().getLocation().getLng());
