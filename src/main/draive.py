...
x = 0;            #positon x axis
y = 0;            #position y axis
width = 0;        #object's width
height = 0;       #object's height

area = 0;

maxArea = 2500;    #max object area
minArea = 1500;     #min object area
Xmin = 120;        #min x position
Xmax = 200;        #max x position
    ...
    while run_flag:
        ...
        if count > 0:
            ...
            if signature == 1:
                ...
                if area <minArea and stop !=1:
                    driver.forward()
                    print("forward")
                    if x<157 and stop != 1:
                        driver.left()
                        print("left")
                    elif x>= 157 and stop!= 1:
                        driver.right()
                        print("right")

                if area > maxArea and stop !=1:
                    driver.backward()
                    print("backward")
